...
async def updata_user(user_id:Annotated[int, Path(ge=1, le=100, description= 'Enter User ID', example='17')],
...
async def delete_user(user_id:int = Path(ge=1, le=100, description= 'Enter User ID', example='17')) -> str:
